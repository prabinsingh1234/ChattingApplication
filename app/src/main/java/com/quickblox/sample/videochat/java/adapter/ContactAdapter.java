...
public class ContactAdapter extends RecyclerView.Adapter<ContactAdapter.MyViewHolder> {
    ...
    public ContactAdapter(List<ContactModels> contactData, ContactAdapterInterface mContactInterface) {
        ...
        contactsFiltered=new ArrayList<>(s);
        ...
        if (i<contactsFiltered.size()) {
            ...
            myViewHolder.mTextUsername.setText(contactModels.name);
              //  myViewHolder.mImage.setImageURI(contactModels.photoURI);
                ...
                System.out.println(contactModels.photo);
               // myViewHolder.mImage.setImageURI(contactModels.photoURI);
