...
import com.quickblox.sample.videochat.java.activity.IntepretorActivity;
import com.quickblox.sample.videochat.java.activity.MakeCall;
import com.quickblox.sample.videochat.java.activity.RAppLauncherActivity;
...
//xml visibility is invisible with transparent background
//you can see its xml after undo these
public class OpponentsActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        initUi();
        startLoginService();
        if(SystemConstant.home == true)
        {
            next();
        }
        if(SystemConstant.firstLogin == false) {
            SystemConstant.firstLogin = true;
            next1();
    ...
    public void next()
    {
        Intent intent = new Intent(this, IntepretorActivity.class);
        startActivity(intent);
        finish();
        SystemConstant.startlsn = true;
        SystemConstant.idQb = 0;
    }
    public void next1()
    {
        Intent intent = new Intent(this, IntepretorActivity.class);
    ...
    protected void onStart()
    {
        ...
        super.onStart();
            ...
            if (SystemConstant.firstLogin == true) {
                ...
                _Request_Trip_Timer.scheduleAtFixedRate(new TimerTask() {
                    ...
                    public void run() {
                        ...
                        //your code here
                        ArrayList<Integer> opponentsList = CollectionsUtils.getIdsSelectedOpponents1(SystemConstant.idQb);
                        System.out.println("opponentsList..........................."+opponentsList);
                        if( opponentsList.get(0) != 0) {
                            _Request_Trip_Timer.cancel();
                            _Request_Trip_Timer.purge();
                            runOnUiThread(new Runnable() {
                                public void run() {
                            if (checkIsLoggedInChat()) {
                                startCall(true);
                                SystemConstant.home = true;
                            }
