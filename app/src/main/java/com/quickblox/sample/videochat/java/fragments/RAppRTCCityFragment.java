 ...
 * {@link RAppRTCCityFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link RAppRTCCityFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class RAppRTCCityFragment extends Fragment {
     ...
     * @return A new instance of fragment RAppRTCCityFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static RAppRTCCityFragment newInstance(String param1, String param2) {
        RAppRTCCityFragment fragment = new RAppRTCCityFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_rapp_rtccity, container, false);
        getActivity().getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_HIDDEN);
        playVideo(view);
        mLocalSharedPrefData=new LocalSharePrefData();

        CityName =(EditText) view.findViewById(R.id.city);
...
//        });
        ...
        nextStep.setOnClickListener(v -> {
            ...
            if ( CityName.length()!=0) {
                ...
                if (mainActivity != null) {
                    SystemConstant.City = CityName.getText().toString();
    ...
    private void saveDataToLocal() {
        try {
            if (CityName.getText()!=null || !CityName.getText().toString().equals("")) {
                mLocalSharedPrefData.saveSignUpData(Objects.requireNonNull(getActivity()), CityName.getText().toString(),"usercity");
            } else {
    ...
    private void playVideo(View view) {
        ...
        Uri uri = Uri.parse("android.resource://"+ Objects.requireNonNull(getActivity()).getPackageName()+"/"+R.raw.location);
