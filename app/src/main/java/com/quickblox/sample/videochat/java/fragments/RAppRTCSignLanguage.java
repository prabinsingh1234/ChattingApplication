 ...
 * {@link RAppRTCSignLanguage.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link RAppRTCSignLanguage#newInstance} factory method to
 * create an instance of this fragment.
 */
public class RAppRTCSignLanguage extends Fragment {
     ...
     * @return A new instance of fragment RAppRTCSignLanguage.
     */
    // TODO: Rename and change types and number of parameters
    public static RAppRTCSignLanguage newInstance(String param1, String param2) {
        RAppRTCSignLanguage fragment = new RAppRTCSignLanguage();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_rapp_rtcsign_language, container, false);
        playVideo(view);
        ...
        nextStep.setOnClickListener(v -> {
            ...
            if ( signLang.length()!=0) {
                ...
                if (mainActivity != null) {
                    //  mainActivity.RAppRTCPasswordFragment();
                    SystemConstant.SIGNLANGUAGE = signLang;
                    mainActivity.RAppRTCCityFragment();

                }
            } else {
                Toast.makeText(getActivity(),"Select Sign Language Country",Toast.LENGTH_LONG).show();
            }
    ...
    private void playVideo(View view) {
        ...
        Uri uri = Uri.parse("android.resource://"+ Objects.requireNonNull(getActivity()).getPackageName()+"/"+R.raw.signlang);
    ...
    private void saveDataToLocal() {
        try {
            if (!signLang.equals("")) {
                mLocalSharedPrefData.saveSignUpData(Objects.requireNonNull(getActivity()),signLang,"usersignlang");
            } else {
                Toast.makeText(getActivity(),"Select Valid Sign Language",Toast.LENGTH_LONG).show();
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
