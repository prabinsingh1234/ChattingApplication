...
import static com.quickblox.sample.videochat.java.fragments.AudioConversationFragment.SPEAKER_ENABLED;
...
//                audioManager.setSpeakerphoneOn(true);
      ...
      //  remoteFullScreenVideoView.setMirror(true);
    ...
    protected void initButtonsListener() {
        ...
        audioSwitchToggleButton.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                System.out.println("SPEAKER ENABLED"+isChecked);
        ...
        micToggleVideoCall.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                System.out.println("MIC_ENABLED"+isChecked);
